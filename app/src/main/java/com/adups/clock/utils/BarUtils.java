...
/**
 * Created by ccl on 2019/4/17 13:28
 */
public class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = ClockApplication.getInstance().getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (ClockApplication.getInstance().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, ClockApplication.getInstance().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = ClockApplication.getInstance().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = ClockApplication.getInstance().getResources();
